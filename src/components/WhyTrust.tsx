...
const points = [
  {
    ...
    body: "Fedde is gebouwd door het team achter Kitchen Royal. Een echte zaak met een naam, een adres en een KvK-nummer. Je weet met wie je te maken hebt.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    body: "Daarom nu 10 betaplekken met een vaste prijs en persoonlijke begeleiding van de oprichter zelf. Je bouwt Fedde mee vanaf het eerste uur.",
  },
];
    ...
    <section className="py-20 sm:py-24">
      <div className="container-x">
        <Reveal className="mx-auto max-w-[640px] text-center">
          <span className="eyebrow">Waarom Fedde</span>
